  ...
  if (!goal) {
    return (
      <div className="bg-white rounded-2xl border border-dashed border-gray-300 p-5 text-center">
        ...
        <p className="text-sm text-gray-600 font-medium">No goal set yet</p>
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 p-5">
      <div className="flex items-center gap-2 mb-3">
        <div className="w-9 h-9 rounded-lg bg-accent2-100 text-brand flex items-center justify-center">
